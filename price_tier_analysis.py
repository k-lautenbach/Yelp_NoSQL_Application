...
DB_NAME         = "yelp_indy"
RESULTS_DIR     = "results"
MIN_BUSINESSES  = 20   # minimum total businesses to include neighborhood
MIN_PER_YEAR    = 5    # minimum new businesses in a year to plot that point
FOCUS_NEIGHBORHOODS = [
    "Fountain Square",
    "Broad Ripple",
    "Near Eastside",
...
for i, neighborhood in enumerate(FOCUS_NEIGHBORHOODS):
    # Filter to this neighborhood, min sample size per year
    ...
    # 3-year rolling average to smooth noise
